...
object TR {
  ...
  val txtEventDetailCount = TypedResource[android.widget.TextView](R.id.txtEventDetailCount)
  ...
  val btnEventDetailAckUnck = TypedResource[android.widget.Button](R.id.btnEventDetailAckUnck)
  ...
  val txtEventDetailDeviceName = TypedResource[android.widget.TextView](R.id.txtEventDetailDeviceName)
  ...
  val btnEventDetailClear = TypedResource[android.widget.Button](R.id.btnEventDetailClear)
  ...
  val txtEventDetailComponent = TypedResource[android.widget.TextView](R.id.txtEventDetailComponent)
  ...
  val txtEventDetailMessage = TypedResource[android.widget.TextView](R.id.txtEventDetailMessage)
  val imgEventAcknowledgedIcon = TypedResource[android.widget.ImageView](R.id.imgEventAcknowledgedIcon)
  val textView6 = TypedResource[android.widget.TextView](R.id.textView6)
  val txtEventDetailLastSeen = TypedResource[android.widget.TextView](R.id.txtEventDetailLastSeen)
  ...
  val btnEventDetailClose = TypedResource[android.widget.Button](R.id.btnEventDetailClose)
  val severity4Box = TypedResource[android.widget.LinearLayout](R.id.severity4Box)
  val txtEventDetailStartTime = TypedResource[android.widget.TextView](R.id.txtEventDetailStartTime)
  ...
  val txtEventDetailSummary = TypedResource[android.widget.TextView](R.id.txtEventDetailSummary)
  ...
  val imgEventDetailSeverityIcon = TypedResource[android.widget.ImageView](R.id.imgEventDetailSeverityIcon)
  val txtEventDetailStatus = TypedResource[android.widget.TextView](R.id.txtEventDetailStatus)
